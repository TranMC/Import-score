...
a = Analysis(
    ...
    hiddenimports=['pandas._libs.tslibs.base', 'pandas._libs.tslibs.np_datetime', 'pandas._libs.tslibs.timedeltas', 'matplotlib', 'matplotlib.backends.backend_tkagg', 'matplotlib.figure', 'matplotlib.backends.backend_pdf', 'matplotlib.colors', 'matplotlib.pyplot', 'matplotlib.rcsetup', 'PIL', 'PIL._tkinter_finder', 'PIL.Image', 'cryptography', 'themes', 'ui_utils', 'version_utils', 'check_for_updates'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
exe = EXE(
    ...
    a.datas,
    [],
    name='Student Score Import v2.2.3',
    debug=False,
